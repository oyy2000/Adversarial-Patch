...
parser.add_argument('--patch_size', type=float, default=3, help='patch size. n * n')
...
parser.add_argument('--netClassifier', default='resnet18', help="The target classifier")
...
netClassifier = pretrainedmodels.__dict__[opt.netClassifier](num_classes=10, pretrained='cifar10')
if opt.cuda:
    netClassifier.cuda()
...
# Normalization parameters for CIFAR10
...
# Set up the DataLoader for the training set
...
# Set up the DataLoader for the test set
...
if __name__ == '__main__':
    ...
    # save patch
    np.save('./%s/patch.npy' %(opt.outf), patch)
